      ...
      <div class="card-content">
        <div class="row">
          ...
          <div class="col s3 right-align">
            <p>
              Saldo: <span class="btn disabled">{{ account.balance }}</span>
            </p>
          </div>
        </div>
        <div class="row">
          <div class="col s12">
            <a :href="'#/contas/' + account.id + '/editar'" class="btn blue"
              >Editar</a
            >
            <a href="" class="btn red" @click.prevent="remove(account.id)"
              >Excluir</a
            >
          </div>
        </div>
