<template>
  <div class="row">
    <div class="content-header">
      <h1>
        Contas bancárias <small>{{ sub_title }}</small>
      </h1>
      <div class="grey-text">
        <small>
          <a href="#/">iFinance</a> > <a href="#/contas">Suas contas</a> >
    ...
    <div class="card col s12">
      <div class="card-content">
        <form class="row" autocomplete="off" @submit.prevent="update">
          ...
          <div class="input-field col s6">
            <input
              ...
              id="title"
              class="validate"
              placeholder="Como você prefere identificar esta conta?"
              required
            />
          ...
          <div class="input-field col s6">
            <input
              v-model="account.balance_initial"
              type="text"
              id="balance_initial"
              class="validate"
              placeholder="Qual o valor inicial desta conta?"
              required
            />
          ...
          <div class="input-field col s6">
            <select class="browser-default" v-model="account.bank_id">
              ...
              <option
                ...
                :value="bank.id"
                class="left circle"
                :selected= "bank.id == account.bank.code"
                >{{ bank.title }} ({{ bank.code }})</option
              >
            </select>
          ...
          <div class="input-field col s6">
            <input
              ...
              id="agency"
              class="validate"
              placeholder="Qual o número da sua agencia?"
              required
            />
          ...
          <div class="input-field col s6">
            <input
              type="submit"
              class="waves-effect waves-light btn-large blue-grey darken-4"
              value="salvar"
            />
          </div>
        </form>
...
export default {
  ...
  computed: {
    banks () {
      return this.$store.state.banks.bankList
    },
    account () {
