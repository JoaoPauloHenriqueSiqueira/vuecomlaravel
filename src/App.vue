      ...
      <div class="col s12 m4 l3 blue-grey padding-top" id="left-side">
        <div class="valign-wrapper">
          <div class="col" layout="row">
            <img
              src="https://www.gravatar.com/avatar/beef4a109b5744b8b51537c0136f7e3b"
              alt="Erik Figueiredo"
              class="circle"
            />
          </div>
          <div>
            <p>
              <span class="grey-text text-lighten-2">Erik Figueiredo</span
              ><br />
        ...
        <div class="collection">
          <a href="#/" class="collection-item grey darken-2 white-text"
            >Financeiro</a
          >
...
export default {
  ...
  styles: [
    ...
    require('ionicons-css/dist/icon.css')
  ]
}
</script>
